...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{url('public/frontend')}}/img/product/logo-home.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">ADMIN RAU MÁ</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{url('public/backend')}}/dist/img/avatar3.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="{{route('admin.login')}}" class="d-block">HUỲNH NGÂN</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fas fas fa-th"></i>
              <p>
                Banner Manager
                <i class="fas fa-angle-left right"></i>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fas fas fa-copy"></i>
              <p>
                Blog Manager
                <i class="fas fa-angle-left right"></i>
